...
def main():
    ...
    parser.add_argument('--data_path', type=str, default="/public/home/lige2022/projects/weights/EEG_Image_decode/Preprocessed_data_250Hz", help='Path to the preprocessed data')
